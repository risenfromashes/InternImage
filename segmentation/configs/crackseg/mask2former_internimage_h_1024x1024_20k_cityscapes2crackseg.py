...
# --------------------------------------------------------
_base_ = [
    '../_base_/models/mask2former_beit.py', '../_base_/datasets/crackseg_1024x1024.py',
    '../_base_/default_runtime.py'
]

num_classes = 2
crop_size = (1024, 1024)
load_from = '../../models/mask2former_internimage_h_1024x1024_80k_mapillary2cityscapes.pth'
model = dict(
